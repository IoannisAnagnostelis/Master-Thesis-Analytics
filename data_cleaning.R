...
pacman::p_load(tidyverse,skimr,GGally,plotly,viridis,caret,randomForest,readxl,
               e1071, rpart,xgboost,h2o,ggcorrplot,rpart.plot, corrgram,
               lightgbm,ggplot2,highcharter,ggthemes,psych,scales,
               treemap,treemapify,repr,cowplot,magrittr,ggpubr, 
               RColorBrewer,plotrix,ggrepel,forcats,reshape2, 
               caTools,tree,rattle,pROC,mclust,car,gbm,
               sjPlot,tictoc,cluster,gridExtra,fmsb,
               doParallel,ggbiplot,readr,pdp,
               randomForest,ggplot2,ROSE,
               DescTools,iml,shapper,ggtext,
               corrplot,DALEX,glmnet,
               inspectdf,dplyr,
               factoextra)
#############################---------####################################
...
str(final_dataset_updated)
names(final_dataset_updated)
